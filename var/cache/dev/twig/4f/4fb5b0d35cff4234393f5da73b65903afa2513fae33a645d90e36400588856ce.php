...
class __TwigTemplate_3d631132db435138c1279eeba89e789d04ab4f2a6334fbb91fc2198e866ea3d3 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a  href=\"";
        // line 9
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("choixMois");
        echo "\"> Choisir mois de consultation  </a>    
";
    ...
    {
        return array (  82 => 9,  78 => 8,  75 => 7,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
{% block body %}
   {# <h1> MENU </h1> {{\$result}}#}
    ...
    <a  href=\"{{ path( 'saisir' ) }}\">Saisir</a>
    <a  href=\"{{ path( 'choixMois') }}\"> Choisir mois de consultation  </a>    
{% endblock %}", "visiteur/visiteur.html.twig", "/var/www/html/GSB-Frais/templates/visiteur/visiteur.html.twig");
    }
}
